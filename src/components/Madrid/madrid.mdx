...
# Mixtape Sessions and CUNEF Universidad present <span class='font-marker'>CodeChella Madrid</span>
...
Tickets are available for purchase via [eventbrite here](https://eventbrite.com/x/792321674457). These tickets include your ticket to the 4 day workshop and morning coffee and pastries. Tickets are $160 for students/post-docs and $310 for faculty. Please email [causalinf@mixtape.consulting](mailto:causalinf@mixtape.consulting) for student discount codes.
...
- How to write a research paper with DID <span class='italic text-xs'>(Dan Reis and Mark Anderson)</span>
